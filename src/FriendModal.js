    ...
    <dialog className="modal overflow-y-scroll" ref={ref}>
      {
        ...
        <div className="w-80 h-80 bg-grey rounded-xl flex flex-col items-center sticky modal-box py-2 px-4">
          ...
          <div className="h-full w-full justify-center items-center flex">
            <button className="btn bg-dark-grey text-red-500 border-0 hover:bg-dark-grey shadow-[0px_2px_2px_rgba(0,0,0,.5)] text-sm" onClick={() => handleUnfriend(record.id)}>Barát törlése</button>
          </div>
        </div> :
