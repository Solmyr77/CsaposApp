...
function ReservationsSwiper() {
    ...
    return (
        <StyledSwipers speed={500} slidesPerView={bookings.length > 1 || bookingsContainingUser.length > 1 ? 1.1 : "auto"} centeredSlides centeredSlidesBounds spaceBetween={10} pagination={{dynamicBullets: true}} modules={[Pagination]} className="mySwiper mb-3 drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] max-h-32">
            {
